...
import { Plus, Trash2, Edit2, GaugeCircle, Sparkles } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';
import toast from 'react-hot-toast';
import { nanoid } from 'nanoid';
import Select from '../../../../components/ui/Select';
import { breakdownAssignment } from '../../../../services/aiService';
...
const TaskBreakdownTab = ({ assignment, onUpdate }) => {
  ...
  const handleBreakdown = async () => {
    ...
    try {
      const generatedTasks = await breakdownAssignment(
        assignment.title, 
      ...
      const newTasks = generatedTasks.map((t) => ({
        ...
        description: t.description || 'Auto-generated by AI',
      ...
      onUpdate({ ...assignment, tasks: updated });
    ...
    <motion.div className="space-y-8">
      ...
      <div className="flex justify-end gap-3">
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 rounded-xl bg-indigo-500 hover:bg-indigo-600 text-white font-black uppercase tracking-widest text-[10px] transition-all active:scale-95 shadow-lg shadow-indigo-500/20 group disabled:opacity-50"
        >
          {isGenerating ? <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" /> : <Sparkles size={18} className="group-hover:scale-110 transition-transform" />}
          {isGenerating ? 'Generating...' : 'Breakdown with AI'}
        </button>
        <button
          ...
          >
            ...
            <div className="space-y-3 min-h-[300px]">
              ...
              {board[column.id].length === 0 && (
                <div className="flex flex-col items-center justify-center h-32 text-center bg-slate-100/50 dark:bg-slate-800/50 rounded-xl border border-dashed border-slate-200 dark:border-slate-700">
